...
#[derive(Debug)]
pub struct TokenForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenForge processing");
    
    let mut processor = TokenForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenForgeProcessor::new(false);
